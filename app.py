...
data_url = r"D:\Virtual_Box\Motor_Vehicle_Collisions_-_Crashes.csv"
st.title("Motor Motor Vehicle Collisions in New York City")
st.markdown("### This application is a Streamlit dashboard that analyze"
...
st.write(
    pdk.Deck(
        ...
        initial_view_state = {
            'latitude' : mid_point[0], #######simple map initial view
            'longitude' : mid_point[1],
            'zoom' : 11,
            'pitch': 50,
        },
        ######## now add layers to map
        layers=[
            pdk.Layer(
                "HexagonLayer",
